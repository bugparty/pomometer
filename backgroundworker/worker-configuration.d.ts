/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 37423f33392d6e615492f509012bfc06)
// Runtime types generated with workerd@1.20250816.0 2025-08-23 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		GOOGLE_CLIENT_ID: "775744900107-pssbnrlhua5vq488t4kdjalulcd2fc0f.apps.googleusercontent.com";
		JWT_SECRET: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "JWT_SECRET" | "GOOGLE_CLIENT_SECRET">> {}
}
