/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 9e1be8e1036e351da8c6814706e52892)
...
declare namespace Cloudflare {
	interface Env {
		...
		JWT_SECRET: string;
        // Added to align with backgroundworker bindings; treat as secret string at runtime
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "JWT_SECRET" | "NEXT_PUBLIC_GOOGLE_CLIENT_ID" | "NEXT_PUBLIC_API_BASE_URL" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN">> {}
}
